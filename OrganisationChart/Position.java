...
public class Position {
    ...
    public double V_SEP = 20; // vertical separation between layers
    ...
    public void addToTeam(Position newMemb) {
        ...
        newMemb.manager = this; // Set the new member to manager
        this.team.add(newMemb); // Add them to the team
    }
    ...
    public void removeFromTeam(Position teamMemb) {
        ...
        teamMemb.manager = null; // Ensure member is not manager
        team.remove(teamMemb); // Remove member from team set
    }
    ...
    public void moveOffsetY(double y) {
        if (manager == null) { // this must be the CEO
            V_SEP = y - ROOT_TOP;
        } else {
            V_SEP = y - manager.getTop();
        }
    }
    ...
    public String toStringFull() {
        return ((role == null || role.equals("") ? "NULL" : role) + " " + (int) (offset) + " " + team.size());
    }
