...
public class Patient implements Comparable<Patient> {
     ...
     * @return -1 if this patient should be treated first,
     * 1 if the other patient should be treated first,
     * 0 if they are equal
     */
    @Override
    public int compareTo(Patient other) {
        ...
        if (this.priority < other.priority) {
            return -1; // Treat this patient first
    ...
    public String toString() {
        ...
        ans.append(", pri:").append(priority).append(", Ar:").append(arrival).append(", ").append("treat: ").append(totalTreatmentTime).append(" wait: ").append(totalWaitTime).append("\n    ");
